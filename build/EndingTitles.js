...
export default class EndingTitles extends Scene {
    posY;
    titles = [' ', 'Jessica Dinova', 'Simon Potocnak', 'Ihor Novikov', 'Simon Manasse', ' ', 'And YOU!', ' ', ' ', 'Credits', ' ', 'Art', ' ', 'PixyMoon, Gif not Jif, Vaca Roxa', ' ', 'Pixel art gallery, Art of MT, Kaleb Silva', ' ', 'Custom cursor, Shubibubi, River makes', ' ', 'Elsthen, Cup noodle, Butter milk', ' ', 'Vector pixel star, Mazeon, RainlDaf', ' ', 'Strelllka, Cyporkador, Craftpix', ' ', 'and Derek Fitzpatrick', ' ', 'Sounds', ' ', 'Fesliyan studios, The podz', ' ', 'Avnish parker and Pix a bay', ' ', 'Font', ' ', 'Data goblin'];
...
//# sourceMappingURL=EndingTitles.js.map